...
from .importing import get_outfit_folder, scan_outfit_presets, get_character_name
...
def register():
    ...
    bpy.types.Scene.arc_outfit_selector_choice = EnumProperty(
        name="Outfit",
        description="Select an outfit by its Flavour name to import all of its parts",
...
def unregister():
    ...
    del bpy.types.Scene.arc_outfit_selector_choice
